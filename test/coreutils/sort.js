...
export const runSortTests = () => {
  describe("sort", function () {
    const testCases = [
      ...
      {
        description:
          "sorts case-insensitively when -f/--ignore-case is specified",
      ...
      {
        description:
          "considers only printing characters when -i/--ignore-nonprinting is specified",
      ...
      {
        description:
          "supports --dictionary-order and --ignore-nonprinting together",
